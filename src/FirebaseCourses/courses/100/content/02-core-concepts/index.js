 ...
 */
const CoreConcepts = ({ course, courseId, courseDisplay, itemConfig }) => {
  ...
  useEffect(() => {
    ...
    setLoading(false);
    console.log(`${courseDisplay.courseId}: Core Concepts lesson loaded`);
      ...
      <div className="my-8">
        ...
        <div className="mb-8">
          ...
          <MultipleChoiceQuestion
            ...
            cloudFunctionName={getCloudFunctionName(courseDisplay.courseId, CONTENT_FOLDER, 'multipleChoice')}
        ...
        <div className="mb-8">
          ...
          <AIMultipleChoiceQuestion
            ...
            cloudFunctionName={getCloudFunctionName(courseDisplay.courseId, CONTENT_FOLDER, 'aiQuestion')}
            course={course}
            theme={courseDisplay.theme?.primaryColor}
