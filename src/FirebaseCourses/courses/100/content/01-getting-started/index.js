 ...
 */
const GettingStarted = ({ course, courseId, courseDisplay, itemConfig }) => {
  ...
  useEffect(() => {
    ...
    setLoading(false);
    console.log(`${courseDisplay.courseId}: Getting Started lesson loaded`);
  ...
  return (
    ...
    >
      ...
      <TextSection title="Welcome to {courseDisplay.title}">
        <p className="mb-4">
          Welcome to this exciting journey! This lesson will help you get started 
          with {courseDisplay.title} and understand what you'll be learning throughout 
          this course.
        </p>
      ...
      >
        <LessonSummary
          points={[
            `Welcome to ${courseDisplay.title} - an exciting learning journey`,
