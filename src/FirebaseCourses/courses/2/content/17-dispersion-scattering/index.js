...
const DispersionScattering = ({ course, courseId = 'default', onPrepopulateMessage, createAskAIButton, createAskAIButtonFromElement,
AIAccordion, onAIAccordionContent }) => {
  
  // Dropdown section states (only for fallback when AIAccordion not available)
  ...
  return (
    ...
    >
      <TextSection>
        {AIAccordion ? (
          <AIAccordion theme="blue" onAskAI={onAIAccordionContent}>
            <AIAccordion.Item value="dispersion" title="Dispersion">
      ...
      <TextSection>
        {AIAccordion ? (
          <AIAccordion theme="blue" onAskAI={onAIAccordionContent}>
            <AIAccordion.Item value="scattering" title="Scattering – Why is the sky blue?">
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                <p className="text-gray-700 mb-4">
      ...
      <TextSection>
        {AIAccordion ? (
          <AIAccordion theme="blue" onAskAI={onAIAccordionContent}>
            <AIAccordion.Item value="colour" title="Colour">
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                <p className="text-gray-700 mb-4">
      ...
      <TextSection>
        {AIAccordion ? (
          <AIAccordion theme="blue" onAskAI={onAIAccordionContent}>
            <AIAccordion.Item value="polarisation" title="Polarisation">
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
