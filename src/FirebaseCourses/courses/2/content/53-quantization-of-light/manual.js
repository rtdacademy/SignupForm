...
const ManualContent = ({ course, courseId, courseDisplay, itemConfig, isStaffView, devMode }) => {
  ...
  const [isBlackbodyOpen, setIsBlackbodyOpen] = useState(false);
  const [isPlanckOpen, setIsPlanckOpen] = useState(false);
  const [isQuantizationOpen, setIsQuantizationOpen] = useState(false);
  const [isElectronVoltOpen, setIsElectronVoltOpen] = useState(false);
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        >
          <h3 className="text-xl font-semibold">🌟 The Quantum Revolution Begins</h3>
      ...
      {/* Blackbody Radiation Section */}
      <div>
        <button
          onClick={() => setIsBlackbodyOpen(!isBlackbodyOpen)}
          className="w-full text-left p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200 flex items-center justify-between"
        >
          <h3 className="text-xl font-semibold">Blackbody Radiation</h3>
          <span className="text-blue-600">{isBlackbodyOpen ? '▼' : '▶'}</span>
        </button>
      ...
      {/* Planck's Quantum Theory Section */}
      <div>
        <button
          onClick={() => setIsPlanckOpen(!isPlanckOpen)}
          className="w-full text-left p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200 flex items-center justify-between"
        >
          <h3 className="text-xl font-semibold">Planck's Quantum Theory</h3>
          <span className="text-blue-600">{isPlanckOpen ? '▼' : '▶'}</span>
        </button>
      ...
      <div>
        ...
        >
          <h3 className="text-xl font-semibold">Example 1: Deriving the Wavelength Formula</h3>
      ...
      <div>
        <button
          ...
          className="w-full text-left p-4 bg-green-50 hover:bg-green-100 rounded-lg transition-colors duration-200 flex items-center justify-between"
        >
          <h3 className="text-xl font-semibold">Example 2: Infrared Photon Energy</h3>
      ...
      <div>
        <button
          ...
          className="w-full text-left p-4 bg-green-50 hover:bg-green-100 rounded-lg transition-colors duration-200 flex items-center justify-between"
        >
          <h3 className="text-xl font-semibold">Example 3: Ruby Laser Photon Count</h3>
      ...
      <div>
        <button
          onClick={() => setIsQuantizationOpen(!isQuantizationOpen)}
          className="w-full text-left p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200 flex items-center justify-between"
        >
          <h3 className="text-xl font-semibold">Quantization</h3>
          <span className="text-blue-600">{isQuantizationOpen ? '▼' : '▶'}</span>
        </button>
      ...
      {/* Electron Volt Section */}
      <div>
        <button
          onClick={() => setIsElectronVoltOpen(!isElectronVoltOpen)}
          className="w-full text-left p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200 flex items-center justify-between"
        >
          <h3 className="text-xl font-semibold">A different unit of energy – the electron volt (eV)</h3>
          <span className="text-blue-600">{isElectronVoltOpen ? '▼' : '▶'}</span>
        </button>
      ...
      <div>
        <button
          ...
          className="w-full text-left p-4 bg-green-50 hover:bg-green-100 rounded-lg transition-colors duration-200 flex items-center justify-between"
        >
          <h3 className="text-xl font-semibold">Example 4: Electron Energy in CRT</h3>
      ...
      <div>
        <button
          ...
          className="w-full text-left p-4 bg-green-50 hover:bg-green-100 rounded-lg transition-colors duration-200 flex items-center justify-between"
        >
          <h3 className="text-xl font-semibold">Example 5: Wavelength from Energy</h3>
