...
const RutherfordAtom = ({ course, courseId, courseDisplay, itemConfig, isStaffView, devMode, AIAccordion, onAIAccordionContent }) => {
  ...
  return (
    <LessonContent
      lessonId="lesson_51_rutherford_atom"
      title="Lesson 27 - Rutherford's Model of the Atom"
    ...
    >
      ...
      <SlideshowKnowledgeCheck
        ...
        title="Rutherford's Atom Knowledge Check"
        description="Test your understanding of Rutherford's gold foil experiment and the discovery of the atomic nucleus."
        questions={[
          {
