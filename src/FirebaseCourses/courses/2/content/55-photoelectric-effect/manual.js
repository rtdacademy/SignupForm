      ...
      {AIAccordion ? (
        <div className="my-8">
          <AIAccordion className="space-y-0">
            <AIAccordion.Item value="discovery" title="Discovery of the photoelectric effect" onAskAI={onAIAccordionContent}>
              <div className="mt-4">
            ...
            <AIAccordion.Item value="einstein" title="Albert Einstein" onAskAI={onAIAccordionContent}>
              <div className="mt-4">
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
            ...
            <AIAccordion.Item value="photoelectric-effect" title="Einstein and the photoelectric effect" onAskAI={onAIAccordionContent}>
              <div className="mt-4">
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
            ...
            <AIAccordion.Item value="example1" title="Example 1: Work Function Calculation" theme="green" onAskAI={onAIAccordionContent}>
              <div className="mt-4">
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
            ...
            <AIAccordion.Item value="example2" title="Example 2: Photoelectron Speed" theme="green" onAskAI={onAIAccordionContent}>
              <div className="mt-4">
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                  <h4 className="font-semibold text-gray-800 mb-3">Problem:</h4>
                  <p className="mb-4">
            ...
            <AIAccordion.Item value="example3" title="Example 3: Finding Light Frequency" theme="green" onAskAI={onAIAccordionContent}>
              <div className="mt-4">
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                  <h4 className="font-semibold text-gray-800 mb-3">Problem:</h4>
                  <p className="mb-4">
            ...
            <AIAccordion.Item value="example4" title="Example 4: Kinetic Energy from Frequencies" theme="green" onAskAI={onAIAccordionContent}>
              <div className="mt-4">
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                  <h4 className="font-semibold text-gray-800 mb-3">Problem:</h4>
                  <p className="mb-4">
            ...
            <AIAccordion.Item value="millikan" title="Millikan's Photoelectric Experiment" onAskAI={onAIAccordionContent}>
              <div className="mt-4">
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
            ...
            <AIAccordion.Item value="example5" title="Example 5: Stopping Voltage and Work Function" theme="green" onAskAI={onAIAccordionContent}>
              <div className="mt-4">
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                  <h4 className="font-semibold text-gray-800 mb-3">Problem:</h4>
                  <p className="mb-4">
