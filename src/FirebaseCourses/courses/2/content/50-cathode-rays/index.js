...
const CathodeRays = ({ course, courseId, courseDisplay, itemConfig, isStaffView, devMode, AIAccordion, onAIAccordionContent }) => {
  ...
  return (
    <LessonContent
      lessonId="lesson_50_cathode_rays"
      title="Lesson 26 - Cathode Rays"
    ...
    >
      ...
      <SlideshowKnowledgeCheck
        ...
        title="Cathode Rays Knowledge Check"
        description="Test your understanding of cathode ray experiments and the discovery of the electron."
        questions={[
          {
