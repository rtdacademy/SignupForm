...
const ManualContent = ({ course, courseId, courseDisplay, itemConfig, isStaffView, devMode }) => {
  ...
  const [isDaltonOpen, setIsDaltonOpen] = useState(false);
  const [isPeriodicOpen, setIsPeriodicOpen] = useState(false);
  const [isMendeleevOpen, setIsMendeleevOpen] = useState(false);
  const [isClassicalOpen, setIsClassicalOpen] = useState(false);

  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-8">Early Atomic Models</h1>
      ...
      <div className="space-y-6">
        ...
        <div>
          <button
            onClick={() => setIsAlchemyOpen(!isAlchemyOpen)}
            className="w-full text-left p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200 flex items-center justify-between"
          >
            <h3 className="text-xl font-semibold">Alchemy</h3>
            <span className="text-blue-600">{isAlchemyOpen ? '▼' : '▶'}</span>
          </button>
        ...
        <div>
          <button
            onClick={() => setIsDaltonOpen(!isDaltonOpen)}
            className="w-full text-left p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200 flex items-center justify-between"
          >
            <h3 className="text-xl font-semibold">Dalton and the Postulates of Chemical Philosophy</h3>
            <span className="text-blue-600">{isDaltonOpen ? '▼' : '▶'}</span>
          </button>
        ...
        {/* Periodic Nature of Elements Section */}
        <div>
          <button
            onClick={() => setIsPeriodicOpen(!isPeriodicOpen)}
            className="w-full text-left p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200 flex items-center justify-between"
          >
            <h3 className="text-xl font-semibold">The Periodic Nature of the Elements</h3>
            <span className="text-blue-600">{isPeriodicOpen ? '▼' : '▶'}</span>
          </button>
        ...
        <div>
          <button
            onClick={() => setIsMendeleevOpen(!isMendeleevOpen)}
            className="w-full text-left p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200 flex items-center justify-between"
          >
            <h3 className="text-xl font-semibold">Dmitri Mendeleev</h3>
            <span className="text-blue-600">{isMendeleevOpen ? '▼' : '▶'}</span>
          </button>
        ...
        {/* Classical Science Section */}
        <div>
          <button
            onClick={() => setIsClassicalOpen(!isClassicalOpen)}
            className="w-full text-left p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200 flex items-center justify-between"
          >
            <h3 className="text-xl font-semibold">Classical Science</h3>
            <span className="text-blue-600">{isClassicalOpen ? '▼' : '▶'}</span>
          </button>
