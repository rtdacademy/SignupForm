...
const ManualContent = ({ course, courseId, courseDisplay, itemConfig, isStaffView, devMode }) => {
  const [isPlanetaryOpen, setIsPlanetaryOpen] = useState(false);
  const [isHydrogenSpectrumOpen, setIsHydrogenSpectrumOpen] = useState(false);
  const [isBohrPostulatesOpen, setIsBohrPostulatesOpen] = useState(false);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Planetary Models of the Atom Section */}
      <div>
        <button
        ...
        >
          <h3 className="text-xl font-semibold">Planetary Models of the Atom</h3>
          <span className="text-blue-600">{isPlanetaryOpen ? '▼' : '▶'}</span>
        </button>
      ...
      {/* Regularities in the Hydrogen Spectrum Section */}
      <div>
        <button
          onClick={() => setIsHydrogenSpectrumOpen(!isHydrogenSpectrumOpen)}
          className="w-full text-left p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200 flex items-center justify-between"
        >
          <h3 className="text-xl font-semibold">Regularities in the Hydrogen Spectrum</h3>
          <span className="text-blue-600">{isHydrogenSpectrumOpen ? '▼' : '▶'}</span>
        </button>
        
        {isHydrogenSpectrumOpen && (
          <div className="mt-4">
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              {/* Historical Context */}
              ...
              {/* Worked Example */}
              <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200 mb-6">
                <h4 className="font-semibold text-yellow-800 mb-3">🧮 Example Calculation: n = 3</h4>
                <p className="text-gray-700 text-sm mb-3">
                  When, for example, we calculate the wavelength for n = 3:
                </p>
                <div className="bg-white p-4 rounded border border-yellow-300">
                  <div className="space-y-3">
                    ...
                    <div className="text-center">
                      <BlockMath math="\frac{1}{\lambda} = 1.0972 \times 10^7 \text{ m}^{-1} \left(\frac{1}{2^2} - \frac{1}{3^2}\right)" />
                    </div>
                    <div className="text-center">
                      <BlockMath math="\frac{1}{\lambda} = 1.0972 \times 10^7 \times \left(\frac{1}{4} - \frac{1}{9}\right) = 1.524 \times 10^6 \text{ m}^{-1}" />
                    </div>
                    <div className="text-center">
                      <BlockMath math="\lambda = \frac{1}{1.524 \times 10^6 \text{ m}^{-1}} = 656.2 \text{ nm (red spectral line)}" />
                    </div>
                  </div>
                  <p className="text-gray-700 text-sm mt-3">
                    When n = 4, 5 and 6 are substituted into the equation, we obtain the wavelengths of the 
                    green, blue and violet lines respectively. Balmer's values were accurate to within 0.02%.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-purple-50 p-4 rounded-lg border border-purple-200 mb-6 mt-6">
                <h4 className="font-semibold text-purple-800 mb-3">🔍 Beyond the Visible Spectrum</h4>
                <p className="text-gray-700 text-sm mb-3">
                  However, being a mathematician, Balmer wanted to know why values above n = 6 could not be used. 
                  When values above n = 6 are substituted, the calculated wavelengths produced are not in the 
                  visible part of the spectrum – they fall into the ultraviolet section of the spectrum.
                </p>
                <div className="bg-white p-3 rounded border border-purple-300">
                  <p className="text-gray-700 text-sm">
                    <strong>Scientific Verification:</strong> It was several years before scientists, using ultraviolet 
                    sensitive film, were able to detect that the lines in the ultraviolet section actually existed.
                  </p>
                </div>
              </div>
              ...
              {/* Example with Rydberg Equation */}
              <div className="bg-cyan-50 p-4 rounded-lg border border-cyan-200 mb-6">
                <h4 className="font-semibold text-cyan-800 mb-3">🔬 Rydberg Equation Example</h4>
                <p className="text-gray-700 text-sm mb-3">
                  When, for example, we calculate the wavelength when <InlineMath math="n_i = 3" /> and <InlineMath math="n_f = 1" /> 
                ...
                <div className="bg-white p-4 rounded border border-cyan-300">
                  <div className="space-y-3">
                    ...
                    <div className="text-center">
                      <BlockMath math="\frac{1}{\lambda} = 1.0972 \times 10^7 \text{ m}^{-1} \left(\frac{1}{1^2} - \frac{1}{3^2}\right)" />
                    </div>
                    <div className="text-center">
                      <BlockMath math="\frac{1}{\lambda} = 1.0972 \times 10^7 \times \left(1 - \frac{1}{9}\right) = 9.753 \times 10^6 \text{ m}^{-1}" />
                    </div>
                    <div className="text-center">
                      <BlockMath math="\lambda = \frac{1}{9.753 \times 10^6 \text{ m}^{-1}} = 102.5 \text{ nm (light is ultraviolet)}" />
                    </div>
                  </div>
                </div>
              </div>

              {/* Discovery of Other Series */}
              <div className="bg-red-50 p-4 rounded-lg border border-red-200 mb-6">
                <h4 className="font-semibold text-red-800 mb-3">🔭 Discovery of Additional Spectral Series</h4>
                <p className="text-gray-700 text-sm mb-3">
                  The work by Balmer and Rydberg encouraged other scientists to search for spectral lines outside 
                  the normal visible light range:
                </p>
                <div className="space-y-3">
                  <div className="bg-white p-3 rounded border border-red-300">
                    <h5 className="font-semibold text-red-700 mb-2">Paschen Series (1908):</h5>
                    <p className="text-gray-700 text-sm">
                      F. Paschen found a whole series of spectral lines generated in the infrared section of the 
                      spectrum for excited hydrogen gas. The lines corresponded to the values that you obtain when 
                      <InlineMath math="n_f = 3" /> and <InlineMath math="n_i" /> is given values of 4, 5, 6, 7 etc.
                    </p>
                  </div>
                  
                  <div className="bg-white p-3 rounded border border-red-300">
                    <h5 className="font-semibold text-red-700 mb-2">Lyman Series (1914):</h5>
                    <p className="text-gray-700 text-sm">
                      Lyman found spectral lines in the ultraviolet part of the spectrum. Lyman's lines corresponded 
                      to <InlineMath math="n_f = 1" /> and <InlineMath math="n_i" /> is given values of 2, 3, 4, 5, etc.
                    </p>
                  </div>
                  
                  <div className="bg-white p-3 rounded border border-red-300">
                    <h5 className="font-semibold text-red-700 mb-2">Further Research:</h5>
                    <p className="text-gray-700 text-sm">
                      Further research by other scientists led to the detection of other spectral line series. 
                      In each case the detection of the series came after the mathematical calculation of the 
                      values using the Rydberg equation.
                    </p>
                  </div>
                </div>
              </div>
      ...
      {/* Bohr's Postulates Section */}
      <div>
        <button
          onClick={() => setIsBohrPostulatesOpen(!isBohrPostulatesOpen)}
          className="w-full text-left p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200 flex items-center justify-between"
        >
          <h3 className="text-xl font-semibold">Bohr's Postulates</h3>
          <span className="text-blue-600">{isBohrPostulatesOpen ? '▼' : '▶'}</span>
        </button>
        
        {isBohrPostulatesOpen && (
          <div className="mt-4">
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
              {/* Bohr's Background */}
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200 mb-6">
      ...
      <div>
        ...
        >
          <h3 className="text-xl font-semibold">Example 1: Energy Transition Calculation</h3>
      ...
      {/* Strengths of the Bohr Model Section */}
      <div>
        <button
          onClick={() => setIsStrengthsOpen(!isStrengthsOpen)}
          className="w-full text-left p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200 flex items-center justify-between"
        >
          <h3 className="text-xl font-semibold">Strengths of the Bohr Model</h3>
          <span className="text-blue-600">{isStrengthsOpen ? '▼' : '▶'}</span>
        </button>
      ...
      {/* Problems with the Bohr Model Section */}
      <div>
        <button
          onClick={() => setIsProblemsOpen(!isProblemsOpen)}
          className="w-full text-left p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200 flex items-center justify-between"
        >
          <h3 className="text-xl font-semibold">Problems with the Bohr Model</h3>
          <span className="text-blue-600">{isProblemsOpen ? '▼' : '▶'}</span>
        </button>
