...
/**
 * Example implementation of a Firebase course for COM1255
 */
const COM1255Course = ({ course }) => {
  const courseId = course.CourseID;
  const lessonId = 'lesson_1746816061030_386'; // Using the itemId from the course structure
