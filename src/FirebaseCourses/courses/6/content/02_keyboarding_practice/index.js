 ...
 */
const TypingPracticeandSpeedBuilding = ({ 
  course, 
  courseId, 
  itemId, 
  activeItem, 
          ...
          {activeSection === 'assessment' && (
            <section className="space-y-6">
              ...
              <SlideshowKnowledgeCheck
                courseId={courseId}
                lessonPath="02_keyboarding_practice"
                course={course}
                questions={[
                  {
                    type: 'multiple-choice',
                    questionId: 'inf2020_02_speed_test',
                    title: 'Speed Test Practice'
                  },
                  {
                    type: 'multiple-choice',
                    questionId: 'inf2020_02_accuracy_test',
                ...
                onComplete={(score, results) => {
                  ...
                  if (allCorrect || score >= 80) {
                    handleQuestionComplete('inf2020_02_speed_test');
                    handleQuestionComplete('inf2020_02_accuracy_test');
                  }
                }}
                theme="purple"
              />
...
export default TypingPracticeandSpeedBuilding;
