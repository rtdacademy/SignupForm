...
const TechnologyReadinessAssistiveTools = ({ course, courseId, itemId, activeItem, onNavigateToLesson, onNavigateToNext, onAIAccordionContent }) => {
      ...
      {activeSection === 'assessment' && (
        <section className="space-y-6">
          ...
          <SlideshowKnowledgeCheck
            courseId={courseId}
            lessonPath="07-technology-readiness-assistive-tools"
            course={course}
            // onAIAccordionContent={onAIAccordionContent}  // Commented out to hide "Ask AI" button
            questions={[
              {
                type: 'multiple-choice',
                questionId: 'course4_07_technology_readiness_question1',
                title: 'Question 1: System Requirements Knowledge'
              },
              {
                type: 'multiple-choice',
                questionId: 'course4_07_technology_readiness_question2',
                title: 'Question 2: Internet Connection Requirements'
              },
              {
                type: 'multiple-choice',
                questionId: 'course4_07_technology_readiness_question3',
                title: 'Question 3: Ergonomic Setup Best Practices'
              },
              {
                type: 'multiple-choice',
                questionId: 'course4_07_technology_readiness_question4',
                title: 'Question 4: Accessibility Features Understanding'
              },
              {
                type: 'multiple-choice',
                questionId: 'course4_07_technology_readiness_question5',
                title: 'Question 5: Proctored Exam Technology'
              },
              {
                type: 'multiple-choice',
                questionId: 'course4_07_technology_readiness_question6',
                title: 'Question 6: Technical Difficulties During Exam'
              },
              {
                type: 'multiple-choice',
                questionId: 'course4_07_technology_readiness_question7',
                title: 'Question 7: Student with Vision Impairment'
              },
              {
                type: 'multiple-choice',
                questionId: 'course4_07_technology_readiness_question8',
                title: 'Question 8: Ergonomic Setup Problems'
              }
            ]}
