...
const ConductExpectationsAlbertaEducationResponsibilities = ({ courseId }) => {
  return (
    <div className="space-y-6">
      <section>
        <h1 className="text-3xl font-bold mb-4">Conduct Expectations & Alberta Education Responsibilities</h1>
        <p className="text-gray-600 mb-6">Student conduct expectations and Alberta Education requirements</p>
      </section>
