          ...
          {activeSection === 'assessment' && (
            <section className="space-y-6">
              ...
              <SlideshowKnowledgeCheck
                courseId={courseId}
                lessonPath="02_data_science_python_basics"
                course={course}
                questions={[
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_02_python_syntax',
                    title: 'Python Syntax and Variables'
                  },
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_02_python_data_structures',
                    title: 'Python Data Structures'
                  },
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_02_python_functions',
                ...
                onComplete={(score, results) => {
                  ...
                  if (allCorrect || score >= 80) {
                    handleQuestionComplete('course5_02_python_syntax');
                    handleQuestionComplete('course5_02_python_data_structures');
                    handleQuestionComplete('course5_02_python_functions');
                  }
                }}
                theme="purple"
              />
...
export default PythonProgrammingBasics;
