          ...
          {activeSection === 'assessment' && (
            <section className="space-y-6">
              ...
              <SlideshowKnowledgeCheck
                courseId={courseId}
                lessonPath="03_data_science_statistics_review"
                course={course}
                questions={[
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_03_statistics_descriptive',
                    title: 'Descriptive Statistics'
                  },
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_03_statistics_probability',
                ...
                onComplete={(score, results) => {
                  ...
                  if (allCorrect || score >= 80) {
                    handleQuestionComplete('course5_03_statistics_descriptive');
                    handleQuestionComplete('course5_03_statistics_probability');
                  }
                }}
                theme="purple"
              />
