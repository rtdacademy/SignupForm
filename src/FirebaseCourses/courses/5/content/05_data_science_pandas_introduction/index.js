          ...
          {activeSection === 'assessment' && (
            <section className="space-y-6">
              ...
              <SlideshowKnowledgeCheck
                courseId={courseId}
                lessonPath="05_data_science_pandas_introduction"
                course={course}
                questions={[
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_05_pandas_dataframes',
                    title: 'Working with DataFrames'
                  },
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_05_pandas_operations',
                ...
                onComplete={(score, results) => {
                  ...
                  if (allCorrect || score >= 80) {
                    handleQuestionComplete('course5_05_pandas_dataframes');
                    handleQuestionComplete('course5_05_pandas_operations');
                  }
                }}
                theme="purple"
              />
...
export default IntroductiontoPandas;
