 ...
 */
const DataVisualizationwithMatplotlib = ({ 
  course, 
  courseId, 
  itemId, 
  activeItem, 
          ...
          {activeSection === 'assessment' && (
            <section className="space-y-6">
              ...
              <SlideshowKnowledgeCheck
                courseId={courseId}
                lessonPath="07_data_science_visualization_basics"
                course={course}
                questions={[
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_07_visualization_plots',
                    title: 'Basic Plot Types'
                  },
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_07_visualization_customization',
                ...
                onComplete={(score, results) => {
                  ...
                  if (allCorrect || score >= 80) {
                    handleQuestionComplete('course5_07_visualization_plots');
                    handleQuestionComplete('course5_07_visualization_customization');
                  }
                }}
                theme="purple"
              />
...
export default DataVisualizationwithMatplotlib;
