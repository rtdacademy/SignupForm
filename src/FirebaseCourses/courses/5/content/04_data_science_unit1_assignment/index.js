...
/**
 * Unit 1 Assignment: Data Analysis Project
 * Type: assignment
 * Estimated Time: 120 minutes
 */
const Unit1AssignmentDataAnalysisProject = ({ 
  course, 
  courseId, 
  itemId, 
  activeItem, 
        ...
        <div className="space-y-8 p-4 sm:p-6 lg:p-8">
          ...
          <section className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-lg p-4 sm:p-6 md:p-8">
            ...
            <p className="text-base sm:text-lg md:text-xl mb-4 sm:mb-6">
              [Add a brief description of this assignment]
            </p>
            ...
            <section className="space-y-6">
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <p className="text-gray-700 mb-4">
                  [Add an overview of what this assignment covers]
                </p>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div className="prose max-w-none">
                  <p className="text-gray-700">
                    [Add the main content for this assignment. You can include:]
                  </p>
            ...
            <section className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto mb-6">
                  Test your understanding of the key concepts from this assignment.
                </p>
              </div>

              <SlideshowKnowledgeCheck
                courseId={courseId}
                lessonPath="04_data_science_unit1_assignment"
                course={course}
                questions={[
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_04_assignment_data_exploration',
                    title: 'Data Exploration'
                  },
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_04_assignment_analysis',
                ...
                onComplete={(score, results) => {
                  ...
                  if (allCorrect || score >= 80) {
                    handleQuestionComplete('course5_04_assignment_data_exploration');
                    handleQuestionComplete('course5_04_assignment_analysis');
                  }
                }}
                theme="blue"
              />
...
export default Unit1AssignmentDataAnalysisProject;
