          ...
          {activeSection === 'assessment' && (
            <section className="space-y-6">
              ...
              <SlideshowKnowledgeCheck
                courseId={courseId}
                lessonPath="10_data_science_ml_fundamentals"
                course={course}
                questions={[
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_10_ml_types',
                    title: 'Types of Machine Learning'
                  },
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_10_ml_workflow',
                    title: 'ML Workflow and Best Practices'
                  }
                ]}
                onComplete={(score, results) => {
                  ...
                  if (allCorrect || score >= 80) {
                    handleQuestionComplete('course5_10_ml_types');
                    handleQuestionComplete('course5_10_ml_workflow');
                  }
                }}
                theme="purple"
              />
