...
const FinalExam = ({ 
  ...
  const allQuestionsCompleted = Object.keys(questionsCompleted).length === 3 && 
        ...
        <div className="space-y-8 p-4 sm:p-6 lg:p-8">
          ...
          <section className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-lg p-4 sm:p-6 md:p-8">
            ...
            <p className="text-base sm:text-lg md:text-xl mb-4 sm:mb-6">
              [Add a brief description of this exam]
            </p>
            ...
            <section className="space-y-6">
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <p className="text-gray-700 mb-4">
                  [Add an overview of what this exam covers]
                </p>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div className="prose max-w-none">
                  <p className="text-gray-700">
                    [Add the main content for this exam. You can include:]
                  </p>
            ...
            <section className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto mb-6">
                  Test your understanding of the key concepts from this exam.
                </p>
              </div>

              <SlideshowKnowledgeCheck
                courseId={courseId}
                lessonPath="11_data_science_final_exam"
                course={course}
                questions={[
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_11_exam_section1',
                    title: 'Foundations and Programming'
                  },
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_11_exam_section2',
                    title: 'Data Manipulation'
                  },
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_11_exam_section3',
                ...
                onComplete={(score, results) => {
                  ...
                  if (allCorrect || score >= 80) {
                    handleQuestionComplete('course5_11_exam_section1');
                    handleQuestionComplete('course5_11_exam_section2');
                    handleQuestionComplete('course5_11_exam_section3');
                  }
                }}
                theme="red"
              />
            ...
            <section className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-lg p-6 sm:p-8">
              ...
              <div className="text-center mb-6">
                <p className="text-lg mb-4">
                  Great job completing this exam!
                </p>
