          ...
          {activeSection === 'assessment' && (
            <section className="space-y-6">
              ...
              <SlideshowKnowledgeCheck
                courseId={courseId}
                lessonPath="09_data_science_unit2_quiz"
                course={course}
                questions={[
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_09_quiz_question1',
                    title: 'Pandas Operations'
                  },
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_09_quiz_question2',
                    title: 'Data Cleaning Concepts'
                  },
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_09_quiz_question3',
                ...
                onComplete={(score, results) => {
                  ...
                  if (allCorrect || score >= 80) {
                    handleQuestionComplete('course5_09_quiz_question1');
                    handleQuestionComplete('course5_09_quiz_question2');
                    handleQuestionComplete('course5_09_quiz_question3');
                  }
                }}
                theme="amber"
              />
