          ...
          {activeSection === 'assessment' && (
            <section className="space-y-6">
              ...
              <SlideshowKnowledgeCheck
                courseId={courseId}
                lessonPath="06_data_science_data_cleaning"
                course={course}
                questions={[
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_06_cleaning_missing_data',
                    title: 'Handling Missing Data'
                  },
                  {
                    type: 'multiple-choice',
                    questionId: 'course5_06_cleaning_outliers',
                ...
                onComplete={(score, results) => {
                  ...
                  if (allCorrect || score >= 80) {
                    handleQuestionComplete('course5_06_cleaning_missing_data');
                    handleQuestionComplete('course5_06_cleaning_outliers');
                  }
                }}
                theme="purple"
              />
...
export default DataCleaningandPreprocessing;
