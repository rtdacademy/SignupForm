...
const assessments = {
  assessment1: {
    ...
    handler: createAIMultipleChoice({
      systemPrompt: `You are an assessment generator for L28-30 Assignment in The Nature of the Atom.`,
      userPrompt: `Generate a multiple choice question about L28-30 Assignment concepts.`,
      temperature: 0.7,
      courseId: 2
    })
  }
