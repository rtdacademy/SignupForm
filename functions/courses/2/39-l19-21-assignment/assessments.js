...
const assessments = {
  assessment1: {
    ...
    handler: createAIMultipleChoice({
      systemPrompt: `You are an assessment generator for L19-21 Assignment in Magnetism.`,
      userPrompt: `Generate a multiple choice question about L19-21 Assignment concepts.`,
      temperature: 0.7,
      courseId: 2
    })
  }
