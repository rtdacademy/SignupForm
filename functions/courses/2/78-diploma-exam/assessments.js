...
const assessments = {
  assessment1: {
    ...
    handler: createAIMultipleChoice({
      systemPrompt: `You are an assessment generator for Diploma Exam in Diploma Exam.`,
      userPrompt: `Generate a multiple choice question about Diploma Exam concepts.`,
      temperature: 0.7,
      courseId: 2
    })
  }
