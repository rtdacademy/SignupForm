...
const assessments = {
  assessment1: {
    ...
    handler: createAIMultipleChoice({
      systemPrompt: `You are an assessment generator for L8-9 Assignment in Optics & Diffraction Gratings.`,
      userPrompt: `Generate a multiple choice question about L8-9 Assignment concepts.`,
      temperature: 0.7,
      courseId: 2
    })
  }
