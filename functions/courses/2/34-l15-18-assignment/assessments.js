...
const assessments = {
  assessment1: {
    ...
    handler: createAIMultipleChoice({
      systemPrompt: `You are an assessment generator for L15-18 Assignment in Electrostatics & Electricity.`,
      userPrompt: `Generate a multiple choice question about L15-18 Assignment concepts.`,
      temperature: 0.7,
      courseId: 2
    })
  }
