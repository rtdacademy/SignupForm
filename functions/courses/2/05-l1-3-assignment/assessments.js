...
const assessments = {
  assessment1: {
    ...
    handler: createAIMultipleChoice({
      systemPrompt: `You are an assessment generator for L1-3 Assignment in Momentum & Impulse.`,
      userPrompt: `Generate a multiple choice question about L1-3 Assignment concepts.`,
      temperature: 0.7,
      courseId: 2
    })
  }
