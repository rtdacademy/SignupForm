...
const assessments = {
  assessment1: {
    ...
    handler: createAIMultipleChoice({
      systemPrompt: `You are an assessment generator for Lesson 19 - Magnetic Fields in Magnetism.`,
      userPrompt: `Generate a multiple choice question about Lesson 19 - Magnetic Fields concepts.`,
      temperature: 0.7,
      courseId: 2
    })
  }
