...
// Question pool 1: Hand Position Knowledge Check
const questionPool1 = [
  {
...
// Question pool 2: Typing Technique Assessment
const questionPool2 = [
  {
    questionText: "[Add question text here]",
    options: [
...
const assessmentConfigs = {
  'inf2020_01_hand_position': {
    ...
    topic: 'Hand Position Knowledge Check',
    learningObjectives: [
  ...
  'inf2020_01_typing_technique': {
    ...
    subject: 'General',
    gradeLevel: 'Multi-Grade',
    topic: 'Typing Technique Assessment',
    learningObjectives: [
      '[Learning objective 1]',
      '[Learning objective 2]',
      '[Learning objective 3]'
