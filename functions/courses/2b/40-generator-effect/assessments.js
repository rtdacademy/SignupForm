...
// ========================================
// INDIVIDUAL QUESTION EXPORTS
// ========================================

// Individual question exports for SlideshowKnowledgeCheck
exports.course2_40_question1 = createStandardMultipleChoice({
  questions: [questionPool[0]], // N-S poles left to right
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question2 = createStandardMultipleChoice({
  questions: [questionPool[1]], // S-N poles left to right
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question3 = createStandardMultipleChoice({
  questions: [questionPool[2]], // S-N poles right to left
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question4 = createStandardMultipleChoice({
  questions: [questionPool[3]], // N-S poles right to left
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question5 = createStandardMultipleChoice({
  questions: [questionPool[4]], // Generator terminals A(-) B(+)
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question6 = createStandardMultipleChoice({
  questions: [questionPool[5]], // Parallel to field lines
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question7 = createStandardMultipleChoice({
  questions: handRuleQuestions, // Hand rules randomized
  randomizeQuestions: true,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question8 = createStandardMultipleChoice({
  questions: [questionPool[6]], // 500 turns coil, 250 turns coil
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question9 = createStandardMultipleChoice({
  questions: [questionPool[7]], // Bar magnet twice as fast
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question10 = createStandardMultipleChoice({
  questions: [questionPool[8]], // Three magnets
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question11 = createStandardMultipleChoice({
  questions: [questionPool[9]], // Energy conversion
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question12 = createStandardMultipleChoice({
  questions: [questionPool[10]], // Suspended charged sphere
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question13 = createStandardMultipleChoice({
  questions: [questionPool[11]], // Left hand rule magnetic poles
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question14 = createStandardMultipleChoice({
  questions: [questionPool[12]], // Airplane
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question15 = createStandardMultipleChoice({
  questions: [questionPool[13]], // 24 cm conductor angle
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question16 = createStandardMultipleChoice({
  questions: [questionPool[14]], // 45 degree angle
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question17 = createStandardMultipleChoice({
  questions: [questionPool[15]], // 22 cm rod circuit resistance
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question18 = createStandardMultipleChoice({
  questions: [questionPool[16]], // 15 cm rod magnetic field calculation
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question19 = createStandardMultipleChoice({
  questions: [questionPool[17]], // 30 cm rod force calculation
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question20 = createStandardMultipleChoice({
  questions: [questionPool[18]], // Rectangular loop
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question20 = createStandardMultipleChoice({
  questions: [questionPool[18]], // Rectangular coil 5 loops
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
// AC Circuit Questions (21-28)
exports.course2_40_question21 = createStandardMultipleChoice({
  questions: [acCircuitQuestions[0]], // Peak current in 3.2k resistor
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question22 = createStandardMultipleChoice({
  questions: [acCircuitQuestions[1]], // RMS and peak current with 180V peak
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question23 = createStandardMultipleChoice({
  questions: [acCircuitQuestions[2]], // Light bulb resistance
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question24 = createStandardMultipleChoice({
  questions: [acCircuitQuestions[3]], // Peak voltage for 1kW device
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question25 = createStandardMultipleChoice({
  questions: [acCircuitQuestions[4]], // Maximum instantaneous power
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question26 = createStandardMultipleChoice({
  questions: [acCircuitQuestions[5]], // Heater coil power analysis
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question27 = createStandardMultipleChoice({
  questions: [acCircuitQuestions[6]], // Current reversals per day
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question28 = createStandardMultipleChoice({
  questions: [acCircuitQuestions[7]], // RMS current with 65V peak
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
// Transformer Questions (29-34)
exports.course2_40_question29 = createStandardMultipleChoice({
  questions: [transformerQuestions[0]], // CD player charger step-down
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question30 = createStandardMultipleChoice({
  questions: [transformerQuestions[1]], // Insect zapper turns calculation
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question31 = createStandardMultipleChoice({
  questions: [transformerQuestions[2]], // Doorbell transformer type
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question32 = createStandardMultipleChoice({
  questions: [transformerQuestions[3]], // Electric train current calculation
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question33 = createStandardMultipleChoice({
  questions: [transformerQuestions[4]], // Power calculation with voltage determination
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_40_question34 = createStandardMultipleChoice({
  questions: [transformerQuestions[5]], // Air filter power consumption
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
