...
// Export individual questions for SlideshowKnowledgeCheck
exports.course2_42_question1 = createStandardMultipleChoice({
  questions: [emrQuestions[0]], // Fundamental origin of EMR
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question2 = createStandardMultipleChoice({
  questions: [emrQuestions[1]], // Harmonic oscillation frequency
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question3 = createStandardMultipleChoice({
  questions: [emrQuestions[2]], // Speed of EMR in vacuum
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question4 = createStandardMultipleChoice({
  questions: [emrQuestions[3]], // Definition of electromagnetic radiation
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question5 = createStandardMultipleChoice({
  questions: [emrQuestions[4]], // Inner electron transitions
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question6 = createStandardMultipleChoice({
  questions: [emrQuestions[5]], // Frequency vs wavelength relationship
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question7 = createStandardMultipleChoice({
  questions: [emrQuestions[6]], // Penetration through human body
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question8 = createStandardMultipleChoice({
  questions: [emrQuestions[7]], // How microwaves cook food
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question9 = createStandardMultipleChoice({
  questions: [emrQuestions[8]], // Night vision cameras
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question10 = createStandardMultipleChoice({
  questions: [emrQuestions[9]], // Honey bee vision
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question11 = createStandardMultipleChoice({
  questions: [emrQuestions[10]], // Microwave frequency calculation
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question12 = createStandardMultipleChoice({
  questions: [emrQuestions[11]], // Radar wavelength calculation
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question13 = createStandardMultipleChoice({
  questions: [emrQuestions[12]], // Power line frequency wavelength
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question14 = createStandardMultipleChoice({
  questions: [emrQuestions[13]], // Red light frequency
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question15 = createStandardMultipleChoice({
  questions: [emrQuestions[14]], // Satellite vs direct transmission delay
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question16 = createStandardMultipleChoice({
  questions: [emrQuestions[15]], // Wavelength from period
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question17 = createStandardMultipleChoice({
  questions: [emrQuestions[16]], // UV light in glass
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question18 = createStandardMultipleChoice({
  questions: [emrQuestions[17]], // Period in Lucite
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question19 = createStandardMultipleChoice({
  questions: [emrQuestions[18]], // Double-slit microwave experiment
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_42_question20 = createStandardMultipleChoice({
  questions: [emrQuestions[19]], // Hydrogen space emissions
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
