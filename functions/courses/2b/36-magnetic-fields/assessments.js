...
exports.course2_36_question1 = createStandardMultipleChoice({
  questions: [questionPool[0]], // Compass under conductor with current A to B
...
exports.course2_36_question2 = createStandardMultipleChoice({
  questions: [questionPool[1]], // Compass over conductor with electrons B to A
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_36_question3 = createStandardMultipleChoice({
  questions: [questionPool[2]], // Compass pointing right, determine current direction
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_36_question4 = createStandardMultipleChoice({
  questions: [questionPool[3]], // Cross-section conductor, current out of page
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_36_question5 = createStandardMultipleChoice({
  questions: [questionPool[4]], // Solenoid with electrons A to B
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_36_question6 = createStandardMultipleChoice({
  questions: [questionPool[5]], // Solenoid with current A to B
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_36_question7 = createStandardMultipleChoice({
  questions: [questionPool[6]], // Solenoid with north pole at top
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_36_question8 = createStandardMultipleChoice({
  questions: [questionPool[7]], // Compass with electron flow north to south
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_36_question9 = createStandardMultipleChoice({
  questions: [questionPool[8]], // Wire north-south, electrons north to south
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_36_question10 = createStandardMultipleChoice({
  questions: [questionPool[9]], // Compass with electron flow south to north
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_36_question11 = createStandardMultipleChoice({
  questions: [questionPool[10]], // Wire north-south, electrons south to north
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_36_question12 = createStandardMultipleChoice({
  questions: [questionPool[11]], // Negatively charged bullet
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_36_question13 = createStandardMultipleChoice({
  questions: [questionPool[12]], // Positively charged bullet
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_36_question14 = createStandardMultipleChoice({
  questions: [questionPool[13]], // Coil with counterclockwise electron flow
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
...
exports.course2_36_question15 = createStandardMultipleChoice({
  questions: [questionPool[14]], // Spinning charged disk
  randomizeQuestions: false,
  randomizeOptions: true,
  allowSameQuestion: true,
  pointsValue: 1,
