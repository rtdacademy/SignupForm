 ...
 * 
 * This module provides assessments for understanding RTD Academy policies
...
const questionPool1 = [
  {
    questionText: "Alex has been struggling with the course content and hasn't yet written the Section 1 exam. He's considering withdrawing from the course. What should Alex know?",
    options: [
      { 
        id: 'a', 
...
// Question pool 2: Maria's MyPass Registration
const questionPool2 = [
  {
...
// Question pool 3: Jordan's Inactivity Situation
const questionPool3 = [
  {
...
// Question pool 4: Course Completion Timeline
const questionPool4 = [
  {
...
// Question pool 5: Section 1 Withdrawal Policy
const questionPool5 = [
  {
...
// Question pool 6: Diploma Exam Registration
const questionPool6 = [
  {
...
// Question pool 7: Course Access Lock Policy
const questionPool7 = [
  {
...
// Question pool 8: Consequence of Not Meeting After Lock
const questionPool8 = [
  {
...
const assessmentConfigs = {
  ...
  'course4_02_learning_plans_question2': {
    type: 'multiple-choice',
  ...
  'course4_02_learning_plans_question3': {
    type: 'multiple-choice',
  ...
  'course4_02_learning_plans_question4': {
    type: 'multiple-choice',
  ...
  'course4_02_learning_plans_question5': {
    type: 'multiple-choice',
  ...
  'course4_02_learning_plans_question6': {
    type: 'multiple-choice',
  ...
  'course4_02_learning_plans_question7': {
    type: 'multiple-choice',
  ...
  'course4_02_learning_plans_question8': {
    type: 'multiple-choice',
