/**
 * Assessment Functions for Unit 2 Quiz
 * Course: 5 
 * Content: 09_data_science_unit2_quiz
 * 
...
// Question pool 1: Pandas Operations
const questionPool1 = [
  {
...
// Question pool 2: Data Cleaning Concepts
const questionPool2 = [
  {
    questionText: "[Add question text here]",
    options: [
...
// Question pool 3: Visualization Best Practices
const questionPool3 = [
  {
    questionText: "[Add question text here]",
    options: [
...
const assessmentConfigs = {
  ...
  'course5_09_quiz_question3': {
    ...
    subject: 'General',
    gradeLevel: 'Multi-Grade',
    topic: 'Visualization Best Practices',
    learningObjectives: [
      '[Learning objective 1]',
      '[Learning objective 2]',
      '[Learning objective 3]'
